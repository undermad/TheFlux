...
namespace Pathfinding.Drawing
{
    ...
    public class DrawingData
    {
        ...
        readonly List<RenderedMeshWithType> meshes = new List<RenderedMeshWithType>();
        readonly List<Mesh> cachedMeshes = new List<Mesh>();
        readonly List<Mesh> stagingCachedMeshes = new List<Mesh>();
        ...
        readonly Dictionary<int, GameObject> persistentRedrawScopes = new Dictionary<int, GameObject>();
        ...
        readonly Dictionary<Camera, Range> cameraVersions = new Dictionary<Camera, Range>();
        ...
        readonly Plane[] frustrumPlanes = new Plane[6];
        // Temporary block, cached to avoid allocations
        readonly MaterialPropertyBlock customMaterialProperties = new MaterialPropertyBlock();
