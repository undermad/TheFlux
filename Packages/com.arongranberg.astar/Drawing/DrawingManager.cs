...
namespace Pathfinding.Drawing
{
    ...
    public static class GizmoContext
    {
        ...
        static readonly HashSet<Transform> selectedTransforms = new HashSet<Transform>();
    ...
    public class DrawingManager : MonoBehaviour
    {
        ...
        static readonly List<GizmoDrawerGroup> gizmoDrawers = new List<GizmoDrawerGroup>();
        static readonly Dictionary<System.Type, int> gizmoDrawerIndices = new Dictionary<System.Type, int>();
#if UNITY_EDITOR
...
#if MODULE_RENDER_PIPELINES_UNIVERSAL
        readonly HashSet<ScriptableRenderer> scriptableRenderersWithPass = new HashSet<ScriptableRenderer>();
