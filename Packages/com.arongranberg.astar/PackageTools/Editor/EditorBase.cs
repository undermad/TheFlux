...
namespace Pathfinding
{
    ...
    public class EditorBase : Editor
    {
        ...
        readonly Dictionary<string, SerializedProperty> props = new Dictionary<string, SerializedProperty>();

        static readonly GUIContent content = new GUIContent();
        static readonly GUIContent showInDocContent = new GUIContent("Show in online documentation", "");
        static readonly GUILayoutOption[] noOptions = new GUILayoutOption[0];
