...
namespace Pathfinding
{
    ...
    public class HierarchicalGraph
    {
        ...
        readonly GlobalNodeStorage nodeStorage;
        ...
        readonly Queue<GraphNode> temporaryQueue = new Queue<GraphNode>();
        readonly List<int> currentConnections = new List<int>();
        readonly Stack<int> temporaryStack = new Stack<int>();
        ...
        readonly RWLock rwLock = new RWLock();
