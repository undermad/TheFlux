...
namespace Pathfinding
{
    ...
    public class AstarDebugger : VersionedMonoBehaviour
    {
        ...
        readonly float graphHeight = 100;
        readonly float graphOffset = 50;
        ...
        readonly PathTypeDebug[] debugTypes = new PathTypeDebug[] {
        ...
        struct PathTypeDebug
        {
            ...
            readonly System.Func<int> getSize;
            readonly System.Func<int> getTotalCreated;
