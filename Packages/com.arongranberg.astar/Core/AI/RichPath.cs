...
namespace Pathfinding
{
    ...
    public class RichFunnel : RichPathPart
    {
        ...
        readonly List<TriangleMeshNode> nodes;
        ...
        RichPath path;
        readonly int[] triBuffer = new int[3];
        ...
        static readonly Queue<TriangleMeshNode> navmeshClampQueue = new Queue<TriangleMeshNode>();
        /// <summary>Cached object to avoid unnecessary allocations</summary>
        static readonly List<TriangleMeshNode> navmeshClampList = new List<TriangleMeshNode>();
        /// <summary>Cached object to avoid unnecessary allocations</summary>
        static readonly Dictionary<TriangleMeshNode, TriangleMeshNode> navmeshClampDict = new Dictionary<TriangleMeshNode, TriangleMeshNode>();
