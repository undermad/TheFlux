...
namespace Pathfinding
{
    ...
    public class SeekerEditor : EditorBase
    {
        ...
        static readonly List<Seeker> scripts = new List<Seeker>();

        readonly GUIContent[] exactnessLabels = new[] { new GUIContent("Node Center (Snap To Node)"), new GUIContent("Original"), new GUIContent("Interpolate (deprecated)"), new GUIContent("Closest On Node Surface"), new GUIContent("Node Connection") };
