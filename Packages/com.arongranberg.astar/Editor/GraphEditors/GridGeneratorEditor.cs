...
namespace Pathfinding
{
    ...
    public class GridGraphEditor : GraphEditor
    {
        ...
        readonly GUIContent[] hexagonSizeContents = {
        ...
        readonly Vector3[] arcBuffer = new Vector3[21];
        readonly Vector3[] lineBuffer = new Vector3[2];
        ...
        readonly Dictionary<GridGraphRule, IGridGraphRuleEditor> ruleEditorInstances = new Dictionary<GridGraphRule, IGridGraphRuleEditor>();
