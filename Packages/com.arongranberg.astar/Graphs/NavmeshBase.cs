...
namespace Pathfinding
{
        ...
        , IRaycastableGraph
    {
        ...
        readonly List<int> batchUpdatedTiles = new List<int>();

        /// <summary>List of nodes that are going to be destroyed as part of a batch update</summary>
        readonly List<MeshNode> batchNodesToDestroy = new List<MeshNode>();
        ...
        readonly Dictionary<int, int> nodeRecyclingHashBuffer = new Dictionary<int, int>();
